...
public class GameControllerTest extends ApplicationTestCase<Application> {
    ...
    public void testIsGameWonInAnyDiagonalBoardEmpty() {
        Board board = new Board(3, 3);

        assertFalse(GameController.isGameWonInAnyDiagonal(board));
    }

    public void testIsGameWonInAnyDiagonalFalse() {
        Board board = new Board(3, 3);

        BoardPiece boardPieceMoe = new BoardPiece("Moe", null);
        board.boardPieces[0][2] = boardPieceMoe;
        board.boardPieces[1][1] = null;
        board.boardPieces[2][0] = boardPieceMoe;

        assertFalse(GameController.isGameWonInAnyDiagonal(board));
    }

    public void testIsGameWonInAnyDiagonalTrue() {
        Board board = new Board(3, 3);
        ...
        assertTrue(GameController.isGameWonInAnyDiagonal(board));
    }
    ...
    public void testIsGameWonInDiagonalSlopeNegativeFalse() {
        Board board = new Board(3, 3);
    ...
    public void testIsGameWonInDiagonalSlopeNegativeTrue() {
        Board board = new Board(3, 3);
    ...
    public void testIsGameWonBoardEmpty() {
        Board board = new Board(3, 3);

        assertFalse(GameController.isGameWon(board));
    }
    ...
    public void testIsGameWonFalse() {
        ...
        board.boardPieces[0][0] = boardPieceMoe;
        board.boardPieces[0][1] = boardPieceLarry;
        board.boardPieces[1][1] = boardPieceMoe;
        board.boardPieces[1][2] = boardPieceLarry;
        board.boardPieces[2][1] = boardPieceMoe;
    ...
    public void testIsGameWonTrue() {
        ...
        assertTrue(GameController.isGameWon(board));
    }
}
